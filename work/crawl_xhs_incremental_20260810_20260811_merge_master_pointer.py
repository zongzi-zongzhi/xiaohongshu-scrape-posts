...
job.BASE_START = datetime(2026, 8, 5, 0, 0, 0, tzinfo=TZ)
job.BASE_END = datetime.combine(datetime(2026, 8, 10).date(), dt_time(23, 59, 59), tzinfo=TZ)
job.INCREMENTAL_START = datetime(2026, 8, 10, 0, 0, 0, tzinfo=TZ)
job.INCREMENTAL_END = NOW
job.TARGET = None
job.KEEP_FIELDS = previous.OUTPUT_FIELDS

job.OLD_SOURCE_JSON = job.OUT_DIR / "xhs_insforge_incremental_merged_20260804_20260810.json"
job.OUT_JSON = job.OUT_DIR / "xhs_insforge_incremental_merged_20260805_20260811.json"
job.OUT_MD = job.OUT_DIR / "xhs_insforge_incremental_merged_20260805_20260811.md"
job.INBOX_MD = job.INBOX / "小红书建联线索池_新格式_增量合并_20260805-20260811.md"
job.FIELDS_JSON = job.WORK_DIR / "xhs_incremental_merged_base_fields_20260805_20260811.json"
job.RECORDS_JSON = job.WORK_DIR / "xhs_incremental_merged_records_payload_20260805_20260811.json"
job.INC_CACHE_JSON = job.OUT_DIR / "xhs_incremental_candidates_20260810_20260811.json"
job.DETAIL_CACHE_JSON = job.WORK_DIR / "xhs_incremental_detail_cache_20260810_20260811.json"
job.VERIFY_STATE_JSON = job.WORK_DIR / "xhs_incremental_verify_required_state_20260810_20260811.json"
job.VERIFY_SCREENSHOT = job.WORK_DIR / "xhs_incremental_verify_required_20260810_20260811.png"
...
STRICT_EXCLUDE = re.compile(
    ...
    r"GitHub\s*热榜|github\s*热榜|GitHub近期热门|GitHub热门项目|GitHub热门|GitHub爆火|GitHub增量榜|AI日报|项目榜|每日\s*AI\s*项目推荐|"
