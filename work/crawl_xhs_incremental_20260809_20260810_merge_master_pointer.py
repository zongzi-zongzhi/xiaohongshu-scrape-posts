...
job.BASE_START = datetime(2026, 8, 4, 0, 0, 0, tzinfo=TZ)
job.BASE_END = datetime.combine(datetime(2026, 8, 9).date(), dt_time(23, 59, 59), tzinfo=TZ)
job.INCREMENTAL_START = datetime(2026, 8, 9, 0, 0, 0, tzinfo=TZ)
job.INCREMENTAL_END = NOW
job.TARGET = None
job.KEEP_FIELDS = previous.OUTPUT_FIELDS

job.OLD_SOURCE_JSON = job.OUT_DIR / "xhs_insforge_incremental_merged_20260803_20260809.json"
job.OUT_JSON = job.OUT_DIR / "xhs_insforge_incremental_merged_20260804_20260810.json"
job.OUT_MD = job.OUT_DIR / "xhs_insforge_incremental_merged_20260804_20260810.md"
job.INBOX_MD = job.INBOX / "小红书建联线索池_新格式_增量合并_20260804-20260810.md"
job.FIELDS_JSON = job.WORK_DIR / "xhs_incremental_merged_base_fields_20260804_20260810.json"
job.RECORDS_JSON = job.WORK_DIR / "xhs_incremental_merged_records_payload_20260804_20260810.json"
job.INC_CACHE_JSON = job.OUT_DIR / "xhs_incremental_candidates_20260809_20260810.json"
job.DETAIL_CACHE_JSON = job.WORK_DIR / "xhs_incremental_detail_cache_20260809_20260810.json"
job.VERIFY_STATE_JSON = job.WORK_DIR / "xhs_incremental_verify_required_state_20260809_20260810.json"
job.VERIFY_SCREENSHOT = job.WORK_DIR / "xhs_incremental_verify_required_20260809_20260810.png"
